package com.rubotnic.api.exception;
...
public class RESTExceptionHandling extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(DataDublicateException.class)
    protected ResponseEntity<Object> dataDublicateException(DataDublicateException ex) {
    ...
    protected ResponseEntity<Object> dataNotFoundException(DataDublicateException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new APIError(HttpStatus.BAD_REQUEST, ex.getMessage()));
    }
    ...
    protected ResponseEntity<Object> constrainViolationException(ConstraintViolationException ex){
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(new APIError(HttpStatus.BAD_REQUEST, ex.getMessage()));
    }
